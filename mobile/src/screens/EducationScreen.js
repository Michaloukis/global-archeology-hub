...
export default function EducationScreen({ onOpenMap }) {
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Edu Lab</Text>
      <Text style={styles.subtitle}>Learning and student resources</Text>
      <View style={styles.card}>
        <Text style={styles.cardText}>
          Full education zone and learning materials are available on the web app.
        </Text>
