...
- Gives **Public** users read-only access to public map and content.
...
**Roles:** Director (full access + exclusive map), Field Archeologist (Arch Zone + journal), Student (Edu Lab + student sites), Public (public map and content only).
