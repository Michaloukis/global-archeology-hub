...
export default function TeamCard({ team, onClick }) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="group text-left w-full aspect-[4/3] sm:aspect-square rounded-2xl bg-white/70 backdrop-blur-sm border border-ink/15 shadow-[0_2px_18px_rgba(44,40,37,0.06)] hover:bg-white/85 hover:border-ink/25 hover:shadow-[0_6px_26px_rgba(44,40,37,0.10)] transition-all p-4 md:p-5 flex flex-col"
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <h3 className="text-[15px] md:text-lg font-semibold text-ink leading-snug truncate">
      ...
      <div className="grid grid-cols-2 gap-2 md:gap-3">
        <div className="rounded-xl border border-ink/10 bg-parchment-100/40 p-2.5 md:p-3">
      ...
      <div className="mt-3 md:mt-4 flex items-center justify-between text-xs text-ink/70">
